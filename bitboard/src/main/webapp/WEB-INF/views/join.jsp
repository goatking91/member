    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="well">
                ...
                <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/member/insert">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" name="nm" placeholder="이름">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" name="birth" placeholder="생년월일 (입력 예: 2000-12-01)">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" name="addrcode" placeholder="우편번호">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-lg-10 col-lg-offset-2">
                                ...
                                <a href="${pageContext.request.contextPath}/index.jsp" class="btn btn-large btn-default">취소</a>
                            </div>
                        </div>
                    </fieldset>
                </form>
